...
util.inherits(Receiver, stream.Stream);
...
function Frame(data, flags) {
	...
	if (arguments.length) {
		flags = flags || {};
		if (flags['final'] === undefined) {
			this.fin = 1;
		} else {
			this.fin = +flags['final'];
		}
		this.rsv1 = 0;
		this.rsv2 = 0;
		this.rsv3 = 0;
		if (flags['opcode'] !== undefined) {
...
exports.OPCODE_CONTINUATION = OPCODE_CONTINUATION;
exports.OPCODE_TEXT = OPCODE_TEXT;
exports.OPCODE_BINARY = OPCODE_BINARY;
