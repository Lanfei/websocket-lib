 ...
 * @param  {Function}      [openListener]             A listener for the 'connect' event.
 * @return {Client}
 */
exports.connect = function (options, openListener) {
	return new exports.Client(options, openListener);
};
