 ...
 * @param  {Function} callback The optional callback parameter will be added as a one time listener for the 'timeout' event.
 * @return {Session}  this
 ...
 */
Session.prototype.sendClose = function (reason) {
	if (this.writable) {
