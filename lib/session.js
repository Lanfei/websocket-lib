...
/** @const */
Session.STATE_CONNECTING = STATE_CONNECTING;
/** @const */
Session.STATE_OPEN = STATE_OPEN;
/** @const */
Session.STATE_CLOSING = STATE_CLOSING;
/** @const */
Session.STATE_CLOSED = STATE_CLOSED;
...
/** @const */
Session.CLOSE_REASON_SERVICE_RESTART = CLOSE_REASON_SERVICE_RESTART;
/** @const */
Session.CLOSE_REASON_TRY_AGAIN_LATER = CLOSE_REASON_TRY_AGAIN_LATER;
/** @const */
